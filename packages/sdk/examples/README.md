...
[`packages/demo/`](../../../demo/) — Full working chat UI application with multi-backend auth, provider management, SSE streaming, and tool execution.
...
See [`packages/demo/README.md`](../../../demo/README.md) for endpoints, configuration, and architecture details.
