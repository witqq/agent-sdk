---
title: "Testing"
description: "Test utilities and mock agent service"
sidebar:
  order: 40
---
...
> `optional` **models**: [`ModelInfo`](/api-reference/core/#modelinfo)[]
...
> `optional` **onRun**: (`prompt`, `options?`) => `Promise`\<[`AgentResult`](/api-reference/core/#agentresult)\<`void`\>\>
...
[`MessageContent`](/api-reference/core/#messagecontent)

###### options?

[`RunOptions`](/api-reference/core/#runoptions)

###### Returns

`Promise`\<[`AgentResult`](/api-reference/core/#agentresult)\<`void`\>\>

##### onStream()?

> `optional` **onStream**: (`prompt`, `options?`) => `AsyncIterable`\<[`AgentEvent`](/api-reference/core/#agentevent)\>
...
> `optional` **validationResult**: [`ValidationResult`](/api-reference/core/#validationresult)
...
> **createMockAgentService**(`options?`): [`IAgentService`](/api-reference/core/#iagentservice)
