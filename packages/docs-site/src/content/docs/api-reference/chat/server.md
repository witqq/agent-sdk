---
title: "Chat Server"
description: "HTTP server handler and auth middleware"
sidebar:
  order: 31
---
# chat/server
...
[`TokenRefreshManager`](/api-reference/auth/#tokenrefreshmanager) \| `undefined`
...
[`ModelInfo`](/api-reference/core/#modelinfo)[]
...
`Promise`\<[`ClaudeAuthToken`](/api-reference/auth/#claudeauthtoken)\>
...
`Promise`\<\{ `userCode`: `string`; `verificationUrl`: `string`; `waitForToken`: (`signal?`) => `Promise`\<[`CopilotAuthToken`](/api-reference/auth/#copilotauthtoken)\>; \}\>
...
[`IChatRuntime`](/api-reference/chat/runtime/#ichatruntime)
...
Re-exports [IProviderStore](/api-reference/chat/index-exports/#iproviderstore)

***

### ProviderConfig

Re-exports [ProviderConfig](/api-reference/chat/index-exports/#providerconfig)

***

### WritableResponse

Re-exports [WritableResponse](/api-reference/chat/backends/#writableresponse)
