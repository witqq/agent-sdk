...
[`ResumableChatAdapter`](/api-reference/chat/backends/#abstract-resumablechatadapter).[`agentService`](/api-reference/chat/backends/#agentservice-3)
...
[`MockLLMChatAdapterOptions`](/api-reference/chat/backends/#mockllmchatadapteroptions)
