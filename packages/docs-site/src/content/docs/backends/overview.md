...
description: "Comparing Copilot CLI, Claude CLI, Vercel AI, and Mock LLM backends"
---
...
**API Reference:** [Core Exports](/api-reference/core/) · [Copilot](/api-reference/backends/copilot/) · [Claude](/api-reference/backends/claude/) · [Vercel AI](/api-reference/backends/vercel-ai/) · [Mock LLM](/api-reference/backends/mock-llm/)
