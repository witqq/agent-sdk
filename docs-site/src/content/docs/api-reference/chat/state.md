---
title: "Chat State"
description: "Reactive state management for chat UI"
sidebar:
  order: 27
---
# chat/state
...
> `const` **MESSAGE\_TRANSITIONS**: [`TransitionMap`](#transitionmap)\<[`MessageStatus`](/api-reference/chat/index-exports/#messagestatus)\>
...
> `const` **RUNTIME\_TRANSITIONS**: [`TransitionMap`](#transitionmap)\<[`RuntimeStatus`](/api-reference/chat/index-exports/#runtimestatus)\>
...
> `const` **TOOL\_CALL\_TRANSITIONS**: [`TransitionMap`](#transitionmap)\<[`ToolCallStatus`](/api-reference/chat/index-exports/#toolcallstatus)\>
...
> **createMessageStateMachine**(): [`StateMachine`](#statemachine)\<[`MessageStatus`](/api-reference/chat/index-exports/#messagestatus)\>
...
[`StateMachine`](#statemachine)\<[`MessageStatus`](/api-reference/chat/index-exports/#messagestatus)\>

***

### createRuntimeStateMachine()

> **createRuntimeStateMachine**(): [`StateMachine`](#statemachine)\<[`RuntimeStatus`](/api-reference/chat/index-exports/#runtimestatus)\>
...
[`StateMachine`](#statemachine)\<[`RuntimeStatus`](/api-reference/chat/index-exports/#runtimestatus)\>

***

### createToolCallStateMachine()

> **createToolCallStateMachine**(): [`StateMachine`](#statemachine)\<[`ToolCallStatus`](/api-reference/chat/index-exports/#toolcallstatus)\>
...
[`StateMachine`](#statemachine)\<[`ToolCallStatus`](/api-reference/chat/index-exports/#toolcallstatus)\>
