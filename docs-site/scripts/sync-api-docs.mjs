 ...
 * and writes to docs-site/src/content/docs/api-reference/.
 *
 * Usage: node docs-site/scripts/sync-api-docs.mjs
 */
...
const API_SRC = join(ROOT, "docs/api");
const API_DEST = join(ROOT, "docs-site/src/content/docs/api-reference");
